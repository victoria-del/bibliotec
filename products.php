...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      $message[] = 'Este livro já existe na estante!';
   }else{
      ...
      if($insert_products){
         if($image_size_01 > 2000000){
            $message[] = 'Aimagem é grande demais!';
         }else{
...
<section class="add-products">
   ...
   <h1 class="heading">Adicionar Livro</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Quantidade disponivél </span>
...
<section class="show-products">
   ...
   <h1 class="heading">Livros adicionados!</h1>
   ...
   <?php
         ...
         echo '<p class="empty">Nenhum Livro adicionado!</p>';
      }
   ?>
