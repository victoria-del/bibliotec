...
if(isset($_POST['update_qty'])){
   ...
   $message[] = 'Quantidade  no carrinho atualizada';
}
...
<section class="products shopping-cart">
   ...
   <h3 class="heading">Estante de livros </h3>
   ...
   <form action="" method="post" class="box">
      ...
      <div class="flex">
         <div class="price">Genero<?= $fetch_cart['price']; ?></div>
   ...
   <div class="cart-total">
      ...
      <a href="shop.php" class="option-btn">Agende mais!</a>
      ...
      <a href="checkout.php" class="btn1 <?= ($grand_total > 1)?'':'disabled'; ?>">Prosseguir</a>
   </div>
